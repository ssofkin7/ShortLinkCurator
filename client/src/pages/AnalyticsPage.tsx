...
export default function AnalyticsPage() {
  ...
  // Bar chart data
  const barChartData = [
    { name: "YouTube", value: platformCounts.youtube || 0 },
    { name: "TikTok", value: platformCounts.tiktok || 0 },
    { name: "Instagram", value: platformCounts.instagram || 0 },
  ];
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar user={user} isLoading={isUserLoading} />
