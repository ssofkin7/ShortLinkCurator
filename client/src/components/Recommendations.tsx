...
const Recommendations = () => {
  ...
  const getPlaceholderImage = (index: number) => {
    const images = [
      "https://images.unsplash.com/photo-1456406644174-8ddd4cd52a06?w=150&h=150&fit=crop",
      "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=150&h=150&fit=crop",
      "https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=150&h=150&fit=crop"
    ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {isLoading
            ...
            : recommendations.map((recommendation, index) => {
                const platform = getPlatformIcon(recommendation.platform);
                return (
