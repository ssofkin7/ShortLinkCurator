  ...
  return (
    <>
      ...
      <section className="mb-10">
        ...
        ) : links.length === 0 && activeTab === 'tiktok' ? (
          <div className="text-center py-10 bg-white rounded-xl border border-gray-200">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-1">No TikTok links yet</h3>
            <p className="text-gray-500">Save a TikTok link to see it here!</p>
          </div>
        ) : links.length === 0 && activeTab === 'youtube' ? (
          <div className="text-center py-10 bg-white rounded-xl border border-gray-200">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-1">No YouTube Shorts yet</h3>
            <p className="text-gray-500">Save a YouTube Shorts link to see it here!</p>
          </div>
        ) : links.length === 0 && activeTab === 'instagram' ? (
          <div className="text-center py-10 bg-white rounded-xl border border-gray-200">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-1">No Instagram Reels yet</h3>
            <p className="text-gray-500">Save an Instagram Reels link to see it here!</p>
          </div>
        ) : (
          <>
